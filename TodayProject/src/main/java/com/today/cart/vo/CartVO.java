package com.today.cart.vo;

public class CartVO {
	
	private long cartNo,goodsNo,optionNo; // 장바구니, 상품, 옵션 번호
	private String id; // 아이디
	private long quantity, totalPrice,opPrice; // 수량, 총가격
	...
	public String toString() {
		return "CartVO [cartNo=" + cartNo + ", goodsNo=" + goodsNo + ", optionNo=" + optionNo + ", id=" + id
				+ ", quantity=" + quantity + ", totalPrice=" + totalPrice + ", opPrice=" + opPrice + ", cup_size="
				+ cup_size + ", cup=" + cup + ", syrup=" + syrup + ", name_kr=" + name_kr + ", name_en=" + name_en
				+ ", goodsview=" + goodsview + ", price=" + price + ", goodsDiv=" + goodsDiv + ", fileName=" + fileName
				+ ", heating=" + heating + "]";
	}
