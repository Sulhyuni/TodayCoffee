...
public class EventApplyUpdateServiceImpl implements ServiceInterface{
	...
	public Object service(Object obj) throws Exception {
		System.out.println("EventApplyUpdateSerivceImpl.service().vo: " + obj);
		
		return dao.applyUpdate((EventVO)obj);
