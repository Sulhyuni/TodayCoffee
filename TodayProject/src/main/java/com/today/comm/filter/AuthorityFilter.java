...
//		authMap.put("/notice/view.do", 1);
		...
		// 이벤트 게시판 권한
//		authMap.put("/event/list.do", 1);
		authMap.put("/event/applyList.do", 1);
		authMap.put("/event/applyWrite.do", 1);
//		authMap.put("/event/view.do", 1);
		authMap.put("/event/write.do", 9);
		authMap.put("/event/update.do", 9);
		authMap.put("/event/applyUpdate.do", 9);
		...
		//상품관리
//		authMap.put("/goods/list.do", 1);
//		authMap.put("/goods/view.do", 1);
