...
<script type="text/javascript">
	function sendCheckValue() {
		var openJoinfrm = opener.document.writeForm;
		...
		if (document.checkIdForm.chResult.value=="N") {
			...
			// 중복체크 결과인 idChecked 값을 전달
			openJoinfrm.idCheck.value="idChecked";
			// 중복체크버튼 disabled로 바꾸기
			openJoinfrm.dbCheckId.disabled=true;
			openJoinfrm.dbCheckId.style.opacity=0.6;
			openJoinfrm.dbCheckId.style.cursor="default";
			//아이디입력창 readonly로 바꾸기
			openJoinfrm.id.readOnly=true;
			openJoinfrm.id.style.opacity=0.7;
			openJoinfrm.id.style.cursor="default";
			window.close();
		}
